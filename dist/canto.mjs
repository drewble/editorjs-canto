...
var k = P.exports;
const R = /* @__PURE__ */ O(k), I = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><rect width="14" height="14" x="5" y="5" stroke="currentColor" stroke-width="2" rx="4"/><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5.13968 15.32L8.69058 11.5661C9.02934 11.2036 9.48873 11 9.96774 11C10.4467 11 10.9061 11.2036 11.2449 11.5661L15.3871 16M13.5806 14.0664L15.0132 12.533C15.3519 12.1705 15.8113 11.9668 16.2903 11.9668C16.7693 11.9668 17.2287 12.1705 17.5675 12.533L18.841 13.9634"/><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.7778 9.33331H13.7867"/></svg>';
class F {
  /**
  ...
  showCantoPreview({ src: g, title: h, caption: v = "", alt: s = "" }) {
    this.nodes.container.appendChild(this.nodes.cantoContent), g && (this.nodes.cantoSrc.src = g, this.nodes.cantoContent.appendChild(this.nodes.cantoSrc), this.nodes.cantoAltLabel = this.make("span", this.CSS.inputLabel), this.nodes.cantoAltLabel.textContent = "Alt Text:", this.nodes.cantoContent.appendChild(this.nodes.cantoAltLabel), this.nodes.cantoAlt.textContent = s, this.nodes.cantoAlt.addEventListener("change", (o) => {
      this.nodes.cantoAlt.textContent = o.target.value;
    }), this.nodes.cantoContent.appendChild(this.nodes.cantoAlt), this.nodes.cantoCaptionLabel = this.make("span", this.CSS.inputLabel), this.nodes.cantoCaptionLabel.textContent = "Caption:", this.nodes.cantoContent.appendChild(this.nodes.cantoCaptionLabel), this.nodes.cantoCaption.textContent = v, this.nodes.cantoContent.appendChild(this.nodes.cantoCaption), this.nodes.cantoCaption.addEventListener("change", (o) => {
      this.nodes.cantoCaption.textContent = o.target.value;
    })), this.nodes.cantoContent.classList.add(this.CSS.cantoContentRendered), this.nodes.cantoContent.setAttribute("href", this.data.src), this.nodes.cantoContent.appendChild(this.nodes.cantoContentId);
  }
  /**
  ...
  onFetch(g) {
    ...
    const h = g.meta, { src: v, title: s, alt: o, caption: i, credit: f, height: l, width: n } = h, { contentId: a } = this.data;
    if (this.data = {
      contentId: a,
      src: v,
      title: s,
